...
export default {
  ...
  mutate: [
    ...
    'src/jsonl/writer.ts:107-115',
    'src/jsonl/writer.ts:228-242',
    'src/jsonl/reader.ts:88-93',
    'src/parser/chunker.ts:38-60',
    'src/maintenance/auto.ts:56-72',
    'src/maintenance/auto.ts:82-136',
    'src/storage/permissions.ts:27-47',
